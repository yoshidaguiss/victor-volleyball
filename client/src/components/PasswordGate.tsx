    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-white to-amber-50 p-4">
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="text-center pb-2">
          ...
          <CardTitle className="text-xl font-bold leading-tight">AID ANALYTICS<br /><span className="text-base font-semibold text-primary">for Volleyball</span></CardTitle>

    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div className="text-center mb-12">
          <div className="mb-6">
            <h1 className="text-3xl md:text-4xl font-black text-gray-900 mb-1">AID ANALYTICS</h1>
          ...
          <p className="text-lg text-gray-600">AID ANALYTICS for Volleyballの基本的な使い方をステップごとに説明します</p>
        </div>
        ...
        <Card className="mb-8 border-2 border-orange-200 bg-orange-50/50">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-2">
              <a href="#intro" className="text-orange-600 hover:underline py-1">1. はじめに - AID ANALYTICSとは？</a>
              <a href="#flow" className="text-orange-600 hover:underline py-1">2. 基本的な流れ</a>
              <a href="#team" className="text-orange-600 hover:underline py-1">3. チームと選手の登録</a>
              <a href="#match" className="text-orange-600 hover:underline py-1">4. 試合を作成する</a>
              <a href="#data" className="text-orange-600 hover:underline py-1">5. データを入力する</a>
              <a href="#coach" className="text-orange-600 hover:underline py-1">6. コーチビューで分析する</a>
              <a href="#ai" className="text-orange-600 hover:underline py-1">7. AI分析を活用する</a>
              <a href="#heatmap" className="text-orange-600 hover:underline py-1">8. ヒートマップを見る</a>
              <a href="#roles" className="text-orange-600 hover:underline py-1">9. 役割分担のススメ</a>
              <a href="#tips" className="text-orange-600 hover:underline py-1">10. 活用のコツ</a>
              <a href="#faq" className="text-orange-600 hover:underline py-1">11. よくある質問</a>
            </div>
          </CardContent>
        </Card>
        ...
        <Card id="intro" className="mb-8 scroll-mt-20">
          <CardHeader className="bg-gradient-to-r from-orange-50 to-amber-50">
            <CardTitle className="flex items-center gap-2 text-2xl">
              ...
              1. はじめに - AID ANALYTICSとは？
            </CardTitle>
          </CardHeader>
          <CardContent className="pt-6">
            <p className="text-gray-700 leading-relaxed mb-4">
              <strong>AID ANALYTICS for Volleyball</strong>は、バレーボールの試合をリアルタイムで記録・分析するためのシステムです。
              スマホやタブレットから簡単に操作でき、試合中のデータ入力からAI分析まで一貫して行えます。
            </p>
            <div className="bg-orange-50 p-4 rounded-lg mb-4">
              <h4 className="font-semibold text-orange-900 mb-3">AID ANALYTICSでできること</h4>
        ...
        <Card id="flow" className="mb-8 scroll-mt-20">
          ...
          <CardContent className="pt-6">
            <p className="text-gray-700 mb-4">AID ANALYTICS for Volleyballの基本的な使い方は以下の5ステップです。</p>
        ...
        <Card id="roles" className="mb-8 scroll-mt-20">
          ...
          <CardContent className="pt-6">
            <div className="space-y-4">
              <p className="text-gray-700">
                AID ANALYTICS for Volleyballは複数のデバイスで同時に使えるため、役割を分担すると効果的です。
              </p>
              <div className="space-y-3">

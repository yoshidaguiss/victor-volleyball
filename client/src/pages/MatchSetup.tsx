              ...
              <TabsContent value="create" className="space-y-6 mt-6">
                <div className="space-y-4">
                  ...
                  {teams && teams.length > 0 && (
                    <div>
                      <Label htmlFor="homeTeamSelect">自チーム（登録済みから選択・任意）</Label>
                      <Select onValueChange={handleHomeTeamSelect}>
                        <SelectTrigger id="homeTeamSelect">
                  ...
                  {teams && teams.length > 0 && (
                    <div>
                      <Label htmlFor="awayTeamSelect">相手チーム（登録済みから選択・任意）</Label>
                      <Select onValueChange={handleAwayTeamSelect}>
                        <SelectTrigger id="awayTeamSelect">
                          <SelectValue placeholder="チームを選択..." />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="__manual__">手入力する</SelectItem>
                          {teams.map(team => (
                            <SelectItem key={team.id} value={team.id.toString()}>
                              {team.teamName} {team.season && `(${team.season})`}
                            </SelectItem>
